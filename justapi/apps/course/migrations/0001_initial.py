# Generated by Django 2.2.2 on 2021-03-24 15:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('popular', models.SmallIntegerField(choices=[(0, '一般课程'), (1, '受欢迎课程')], default=0, verbose_name='课程受欢迎程度')),
                ('project', models.SmallIntegerField(choices=[(0, '理论课程'), (1, '项目实战')], default=0, verbose_name='是否为项目实战课程')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.SmallIntegerField(choices=[(0, '一般讲师'), (1, '高级讲师'), (2, '优秀讲师')], default=0, verbose_name='导师级别')),
                ...
                ('email', models.EmailField(default='316504849@qq.com', max_length=64, verbose_name='导师联系方式')),
            ],
            options={
                'verbose_name': '导师',
